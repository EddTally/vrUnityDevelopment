...
public class UIController2ndScene : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (col != null) //Don't have to go through the whole loop if its null, saves time
            {
                ...
                if (middleDpadClick.GetState(handType) && col == playCol)
                {
                ...
                if (middleDpadClick.GetState(handType) && col == ffCol)
                {
                ...
                /* ------------------------------------- Rewind ------------------------------------ */
                //If middleDpadClick and Raycast Collider hits fastforward collider, fastforward
                if (middleDpadClick.GetState(handType) && col == rewindCol)
                {
                ...
                if (middleDpadClick.GetState(handType) && col == ffMenu)
                {
                ...
                if (middleDpadClick.GetState(handType) && (col == ff15s || col == ff30s || col == ff1m))
                {
                ...
                if (middleDpadClick.GetState(handType) && (col == rewind15s || col == rewind30s || col == rewind1m))
                {
                ...
                /* --------------------------------- Volume Controls ---------------------------------*/
                if (middleDpadClick.GetState(handType) && col == volumeCol)
                {
